...
def _default_compute_score(config, data_source, solution_str, ground_truth, extra_info=None, tool_on_ratio=None, epoch=None):
    # print(f'{data_source=} ### {solution_str=} ### {ground_truth=} ### {extra_info=}')
    if data_source == "openai/gsm8k":
        ...
        res = vl_agent.compute_score(config, solution_str, ground_truth, extra_info, data_source, tool_on_ratio, epoch=epoch)
        ...
        from . import vl_agent
        res = vl_agent.compute_score_math(solution_str, ground_truth, extra_info, data_source)
