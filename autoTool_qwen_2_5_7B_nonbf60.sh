...
EXPERIMENT_NAME="autoTool_qwen_2_5_7B_nonbf60"


export CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7
export LLM_AS_A_JUDGE_BASE="http://xxx:yyy/v1"
export WORLD_SIZE=1

export SAVE_CHECKPOINT_DIR=/xxx/AutoTool/verl_checkpoints
# export VLLM_ATTENTION_BACKEND=XFORMERS # vllm + qwen2-7b with flash_attn has some issues

BASEDIR=/xxx/huggingface/hub/datasets--ChenShawn--DeepEyes-Datasets-47k/snapshots/5546681e28fa2eda9f60a9ea9dd0cf291216ded3
...
REF_MODEL_PATH=/xxx/huggingface/hub/models--Qwen--Qwen2.5-VL-7B-Instruct
HYDRA_FULL_ERROR=1 PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    trainer.total_epochs=1 2>&1 | awk '{ print strftime("%Y-%m-%d %H:%M:%S"), $0; fflush(); }' | tee ./logs/${EXPERIMENT_NAME}_$(date +%Y%m%d_%H%M%S).log
